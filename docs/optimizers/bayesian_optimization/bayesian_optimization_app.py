...
def bayesian_optimization_app():
    ...
    col2.image(os.path.join(here_, "_images/bayesian_optimization_0.gif"))
    col3.image(os.path.join(here_, "_images/bayesian_optimization_1.gif"))
    col2.image(os.path.join(here_, "_images/bayesian_optimization_2.gif"))
    col3.image(os.path.join(here_, "_images/bayesian_optimization_3.gif"))
